...
export default function ResultsGrid({bracketResults}) {
  ...
  return <article className={classes.content}>
    <DataTable value={xformedResults} tableStyle={{minWidth: '420px'}}>
      ...
      <Column field='income' header='Taxable Income' align='right' headerStyle={{lineHeight: '1.2'}} dataType='currency'></Column>
      <Column field='totaltax' header='Bracket Tax Total' align='right' headerStyle={{lineHeight: '1.2'}} dataType='currency'></Column>
    </DataTable>
    <TotalsBar 
